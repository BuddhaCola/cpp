...
class ClapTrap {
	...
	public:
		...
		ClapTrap(unsigned int _HP, unsigned int _maxHP, unsigned int _energyPoints, unsigned int _maxEnergyPoints, unsigned int _level, std::string  _name, std::string _type, unsigned int _meleeAttackD, unsigned int _rangeAttackD, unsigned int _armorDamageReduction);
